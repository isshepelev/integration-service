...
> **Примечание:** Все страницы веб-интерфейса локализованы на русский язык.
...
На главной странице (на русском языке) доступны кнопки для перехода к документации и примерам всех API.

### Страницы с примерами

| URL | Описание |
|-----|----------|
| http://localhost:8080/graphql-examples | Примеры GraphQL запросов с описанием схемы |
| http://localhost:8080/graphql-playground | Интерактивный редактор GraphQL запросов |
| http://localhost:8080/grpc-examples | Примеры gRPC вызовов с командами grpcurl |
| http://localhost:8080/soap-examples | Примеры SOAP XML запросов |

Каждая страница содержит:
- Обзор схемы/сервисов
- Информацию о подключении
- Готовые примеры запросов с ответами
